package com.g13.DRAG.distribuido.list.view
...
class ChallengeViewHolder(private val view: ViewGroup) : RecyclerView.ViewHolder(view) {
    ...
    private val challengerNameView: TextView = view.findViewById(R.id.PlayerName) //the view is also used for the high scores, so we had to use confusing IDs
